    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="The most popular AMM on BSC! Earn DOODZ through yield farming or win it in the Lottery, then stake it in ChocoChip Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by DoodleSwap), NFTs, and more, on a platform you can trust."
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="😻 DoodleSwap - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
        <title>DoodleSwap Bridge</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
