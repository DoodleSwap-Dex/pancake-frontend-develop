...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('DOODLE', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('DOODZ + Fees')
  ...
  const isPromotedFarm = farm.token.symbol === 'DOODZ'
