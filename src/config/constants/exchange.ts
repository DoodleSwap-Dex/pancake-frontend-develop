...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.BSC]: '0x77874f119360EE305Fe423FDf269Bab6a80AbfB7',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.doodz, bscTestnetTokens.busd],
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.busd, bscTokens.doodz, bscTokens.btcb],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.doodz, bscTestnetTokens.busd],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [USDC[ChainId.RINKEBY], WNATIVE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
  [ChainId.BSC]: [bscTokens.wbnb, bscTokens.dai, bscTokens.busd, bscTokens.usdt, bscTokens.doodz],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.doodz, bscTestnetTokens.busd],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.BSC]: [
    [bscTokens.doodz, bscTokens.wbnb],
...
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0x3c5abAFB2bad7998A5BfFB21191De2E20AF1F9D5'
